...
<head>
  ...
  <meta property="og:image" content="@yield('og_image', get_social_image_url())">
  ...
  <meta name="twitter:image" content="@yield('twitter_image', get_social_image_url())">
  ...
  <meta property="zalo:image" content="@yield('og_image', get_social_image_url())">
  
  <!-- Additional Open Graph for better compatibility -->
  <meta property="og:image:secure_url" content="@yield('og_image', get_social_image_url())">
